...
class BaseDetailViewController: UIViewController {
    ...
    var seriesDetailViewModel: SeriesViewModel?
...
//        }
    ...
    @objc private func userTapFavorite() {
        ...
        if let seriesDetailViewModel = seriesDetailViewModel {
            seriesDetailViewModel.detailPageTapFavorite(withFavoriteButton: favoriteButton)
        }
    ...
    private func checkFavorites() {
        ...
        if let seriesDetailViewModel = seriesDetailViewModel {
            seriesDetailViewModel.getFavoriteStatus(withFavoriteButton: favoriteButton)
        }
    }
